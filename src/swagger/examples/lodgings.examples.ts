export const lodgingResponseExample = {
  id: '65f1c2d9a2b5c9f1a2b3c4d5',
  title: 'Cabana Frente al Mar',
  description: 'Hermosa cabana equipada para 4 personas.',
...
export const publicLodgingResponseExample = {
  id: lodgingResponseExample.id,
  title: lodgingResponseExample.title,
  description: lodgingResponseExample.description,
  location: lodgingResponseExample.location,
  city: lodgingResponseExample.city,
  type: lodgingResponseExample.type,
  price: lodgingResponseExample.price,
  priceUnit: lodgingResponseExample.priceUnit,
  maxGuests: lodgingResponseExample.maxGuests,
  bedrooms: lodgingResponseExample.bedrooms,
  bathrooms: lodgingResponseExample.bathrooms,
  minNights: lodgingResponseExample.minNights,
  distanceToBeach: lodgingResponseExample.distanceToBeach,
  amenities: lodgingResponseExample.amenities,
  mainImage: lodgingResponseExample.mainImage,
  images: lodgingResponseExample.images,
  mediaImages: [
    {
      imageId: '244e45ae-bdb3-407b-adf2-ade015e1a5ef',
      isDefault: true,
...
export const adminLodgingsPaginatedResponseExample = {
  data: [lodgingResponseExample],
  total: 1,
  page: 1,
  limit: 10,
};

export const publicLodgingsPaginatedResponseExample = {
  data: [publicLodgingResponseExample],
  total: 12,
  page: 1,
  limit: 10,
};
